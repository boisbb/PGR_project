...
namespace test_model
{
    ...
    ChevyCamaro::ChevyCamaro(GLFWwindow* window) 
        : m_Window(window)
    {
        ...
        m_Model = std::make_unique<Model>("res/models/camaro/camaro.obj", "res/models/camaro/");
    ...
    void ChevyCamaro::OnUpdate(float deltaTime) 
    {
        
    }
    
    void ChevyCamaro::OnRender() 
    {
    ...
    void ChevyCamaro::OnImGuiRender() 
    {
