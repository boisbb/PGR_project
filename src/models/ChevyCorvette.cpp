...
{
    ChevyCorvette::ChevyCorvette() 
        : m_ClearColor {0.2f, 0.3f, 0.8f, 1.0f}
    {
    }

    ChevyCorvette::ChevyCorvette(GLFWwindow* window) 
        : m_Window(window)
    {
        ...
        m_Model = std::make_unique<Model>("res/models/corvette/corvette.obj", "res/models/corvette/");
    ...
    void ChevyCorvette::OnUpdate(float deltaTime) 
    {
        
    }
    
    void ChevyCorvette::OnRender() 
    {
    ...
    void ChevyCorvette::OnImGuiRender() 
    {
