...
namespace test_model
{
    ...
    DynamicCubeMap::DynamicCubeMap(GLFWwindow* window, int width, int height) 
        : m_Window(window), WIDTH(width), HEIGHT(height)
    {
        modelInit();
    }

    void DynamicCubeMap::modelInit()
    {
        m_DynamicCubeMapModel = std::make_unique<Model>("res/models/porsche/porsche.obj", "res/models/porsche/");
        m_PlaneModel = std::make_unique<Model>("res/models/plane2/plane2.obj", "res/models/plane2/");
        ...
        m_Shader = std::make_unique<Shader>("res/shaders/dynamiccubemap.shader");
    ...
    void DynamicCubeMap::ModelReinit(int width, int height) 
    {
        WIDTH = width;
        HEIGHT = height;
        modelInit();
    ...
    void DynamicCubeMap::OnUpdate(float deltaTime) 
    {
        
    }
    
    void DynamicCubeMap::OnRender() 
    {
        ...
        glBindTexture(GL_TEXTURE_CUBE_MAP, textureID);
        m_DynamicCubeMapModel->Draw(*m_Shader, *m_Camera, glm::vec3(1.0, 1.0, 1.0), glm::vec3(0.0, -0.5, 0.0));
    ...
    void DynamicCubeMap::OnImGuiRender() 
    {
