...
{
    PorscheCayman::PorscheCayman() 
        : m_ClearColor {0.2f, 0.3f, 0.8f, 1.0f}
    {
    }

    PorscheCayman::PorscheCayman(GLFWwindow* window) 
        : m_Window(window)
    {
        m_Shader = std::make_unique<Shader>("res/shaders/skyboxobject.shader");
    ...
    void PorscheCayman::OnUpdate(float deltaTime) 
    {
        
    }
    
    void PorscheCayman::OnRender() 
    {
    ...
    void PorscheCayman::OnImGuiRender() 
    {
